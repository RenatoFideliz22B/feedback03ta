...
export function App() {
  ...
  return (
    submited === false ? (
      ...
      <p className="text-sm text-light-grey mb-6">Please let us know how we did with your support request. All feedback is appreciated to help us improve our </p>
      ...
      <div className="max-w-103 bg-gradient-dark p-6 rounded-2xl text-white font-overpass text-center">
        ...
        <p className="text-sm text-light-grey mb-6">We appreciate you taking the time to give a rating. If you even need more support, don' t hesitate to get in touch!</p>
      </div>
    )
  )
}